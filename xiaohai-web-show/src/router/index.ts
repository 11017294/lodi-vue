...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      { path: '/category', meta: { title: '分类' }, component: () => import('@/views/category/CategoryIndex.vue') },
      { path: '/tags', meta: { title: '标签' }, component: () => import('@/views/tags/TagsIndex.vue') },
      { path: '/back', meta: { title: '归档' }, component: () => import('@/views/back/BackIndex.vue') },
      { path: '/message', meta: { title: '留言版' }, component: () => import('@/views/message/MessageIndex.vue') },
      { path: '/links', meta: { title: '友链' }, component: () => import('@/views/links/LinksIndex.vue') },
      { path: '/about', meta: { title: '关于' }, component: () => import('@/views/about/AboutIndex.vue') },
      { path: '/article/:id', meta: { title: '文章' }, component: () => import('@/views/article/ArticleIndex.vue') },
